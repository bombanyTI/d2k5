/obj/item/device/paicard
	...
	Topic(href, href_list)
		...
		if(href_list["setlaws"])
			var/newlaws = strip_html(input("Enter any additional directives you would like your pAI personality to follow. Note that these directives will not override the personality's allegiance to its imprinted master. Conflicting directives will be ignored.", "pAI Directive Configuration", pai.pai_laws)) as message
			if(newlaws)
